...
class Universe {
  ...
  init() {
    ...
    this.curveDom = document.createElementNS(SVGNS, 'g');
    this.dom.appendChild(this.curveDom);

    this.curve = new KBJCurve();
    this.curveDom.appendChild(this.curve.dom);
